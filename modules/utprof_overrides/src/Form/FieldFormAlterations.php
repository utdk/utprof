...
namespace Drupal\utprof_overrides\Form;
...
use Drupal\utprof_overrides\Config\ConfigOverrider;
...
class FieldFormAlterations implements ContainerInjectionInterface {
  ...
  /**
   * The utprof configuration overrider service.
   *
   * @var \Drupal\utprof_overrides\Config\ConfigOverrider
   */
  protected $utprofOverridesOverrider;

  /**
   * EntityTypeInfo constructor.
   *
   * @param \Drupal\utprof_overrides\Config\ConfigOverrider $utprof_overrides_overrider
   *   The utprof configuration overrider service.
   */
  public function __construct(ConfigOverrider $utprof_overrides_overrider) {
    $this->utprofOverridesOverrider = $utprof_overrides_overrider;
  }
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('utprof_overrides.overrider')
    );
  }
  ...
  public function fieldConfigEditFormAlter(array &$form, FormStateInterface $form_state, $form_id) {
    $allowed_media_bundles = $this->utprofOverridesOverrider->getImageMediaBundles();
